...
static int create_subprocess(int* pProcessId)
{
    char *devname;
    int ptm;
    pid_t pid;
...
static const char *classPathName = "com/addi/Exec";

static JNINativeMethod method_table[] = {
    { "createSubprocess", "([I)Ljava/io/FileDescriptor;",
