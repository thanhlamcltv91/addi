...
if (initDone) MyKeyboard.this.parent.runOnUiThread(new Runnable(){public void run(){
MyKeyboard.this.setShifted(false);
}});
}
@Override
...
public MyKeyboard(Context c, boolean undoEnabled, boolean redoEnabled)
{
this(c,null);
...
public MyKeyboard(Context c, AttributeSet a)
{
super(c,a);
parent = (Addi)c;
...
for (int i=0; i<s.length();i++) parent.keyEvent(0,0,s.charAt(i));
}
